...
struct Resume {
  ...
  static let mailtoString = "mailto:"
  static let myEmail = "paul.wood.iii@gmail.com"
  static let contactEmailUrlString = mailtoString+myEmail
  ...
  let contact: [ContactInfo] = [
    ...
    ContactInfo(type:"Phone",
                value:"843-253-3496",
                urlString:"telprompt:843-253-3496"),
